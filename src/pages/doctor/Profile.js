...
const Profile = () => {
    ...
    const params = useParams(); // /doctor/profile/:id isme se id get karne ke liye kaam aata hai
  ...
  const handleFinish = async (values) => {
    ...
    const getDoctorInfo = async () => {
        try {
            // get nahi karna hai use kyuki get mei {userId: params.id} yeh wala bracket valid nahi hota hai
